return function(programs)
    ...
    hl.bind(mod .. " + M", hl.dsp.exec_cmd(scripts .. "minimize"), { description = "Minimér aktivt vindue" })
    hl.bind(mod .. " + ALT + M", hl.dsp.exec_cmd(scripts .. "restore-minimized"), { description = "Gendan minimerede vinduer" })
